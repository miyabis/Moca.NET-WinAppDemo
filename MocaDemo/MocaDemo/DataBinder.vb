...
#Region " プロパティ "
		...
		'	Get
		'		Return DirectCast(Me.BindSrc.DataSource, DataTable)
		'	End Get
		'	Set(ByVal value As DataTable)
		'		_ds = Nothing

		'		If value IsNot Nothing Then
		'			If value.DataSet Is Nothing Then
		'				_ds = New DataSet()
		'			Else
		'				_ds = value.DataSet
		'			End If
		'			AddHandler value.ColumnChanging, AddressOf _rowChanging
		'		End If
		...
		''' <returns></returns>
		''' <remarks></remarks>
		Public Function CurrentEntity(Of T)() As Object
			If _current Is Nothing Then
				Return Nothing
			End If
